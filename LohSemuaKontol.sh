...
echo $red"            harap sabar njeng menunggu yaa sayang :v("   
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo $pur"▪▪▪▪▪▪▪▪▪▪▪▪"$cy" ▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪▪"
echo $i"Ôûê"$pu"  AUTHOR  :  ீ͜҉ৡৢ͜͡ÆripiŇꍏீ҉͜ৡৢ͜͡  "$i"                    Ôûê"
echo $i"Ôûê"$pu"  WhatsApp:  089629966237"$i"                Ôûê"
echo $i"Ôûê"$pu"  GMAIL   :  arifinputraaa03@gmail.com"$i"     Ôûê"
echo $i"Ôûê"$pu"  YOUTUBE :  YouTube Æripin"$i"                 Ôûê"
echo $pur"••••••••••••••••••••••••••"$cy" •••••••••••••••••••••••••••••••••••••••••••••"
echo
...
echo $ku"["$me"12"$ku"]"$i" LACAK LOKASI orang tod"
...
sleep 2
echo $ku"Facebook :"$i" Aripin"
echo $ku"YouTube  :"$i" YouTube Æripin"
echo $ku"WhatsApp :"$i" 088629966237"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE Æripin Dan Juga loh Semua Kontol }"
exit
fi
